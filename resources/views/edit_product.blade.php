          ...
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            ...
            <div class="row tm-edit-product-row">
              <div class="col-xl-12 col-lg-12 col-md-12">
                <form action="{{ route('editCar', ['id' => $car->id]) }}" class="tm-edit-product-form" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group mb-3">
                        <label for="name">Car Name</label>
                        <input id="name" name="name" type="text" class="form-control validate border" value="{{$car->name}}"/>
                        <small class="error-message"></small>
                    </div>
                
                    <div class="form-group mb-3">
                        <label for="price">Price</label>
                        <input id="price" name="price" type="number" class="form-control validate border" value="{{$car->price}}"/>
                        <small class="error-message"></small>
                    </div>
                
                    <div class="form-group mb-3">
                        <label for="year_of_manufacture">Year of Manufacture</label>
                        <input id="year_of_manufacture" name="year_of_manufacture" type="number" class="form-control validate border" value="{{$car->year_of_manufacture}}" />
                        <small class="error-message"></small>
                    </div>
                
                    <div class="form-group mb-3">
                        <label for="mileage">Mileage</label>
                        <input id="mileage" name="mileage" type="text" class="form-control validate border" value="{{$car->mileage}}"/>
                        <small class="error-message"></small>
                    </div>
                
                    <div class="form-group mb-3">
                        <label for="city">City</label>
                        <input id="city" name="city" type="text" class="form-control validate border" value="{{$car->city}}" />
                        <small class="error-message"></small>
                    </div>
                
                    <div class="form-group mb-3">
                        <label for="description">Description</label>
                        <textarea class="form-control validate border" name="description" rows="3" > {{$car->description}}</textarea>
                        <small class="error-message"></small>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group mb-3 col-xs-12 col-sm-6">
                            ...
                            <input id="seats" name="seats" type="number" class="form-control validate border" data-large-mode="true" value="{{$car->seats}}"/>
                        </div>
                        <div class="form-group mb-3 col-xs-12 col-sm-6">
                            <label for="luggage">Luggage</label>
                            <input id="luggage" name="luggage" type="number" class="form-control validate border" value="{{$car->luggage}}"/>
                        </div>
                        <small class="error-message"></small>
                    </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 mx-auto mb-4">
                        ...
                        <div class="custom-file mt-3 mb-3 m-5">
                            <img src="{{ asset('images/' . $car->img_1) }}" alt="img_1_car" style="width: 485px">
                        ...
                        <div class="custom-file mt-3 mb-3 m-5">
                            <img src="{{ asset('images/' . $car->img_2) }}" alt="img_2_car" style="width: 485px">
                        ...
                        <div class="custom-file mt-3 mb-3 m-5">
                            <img src="{{ asset('images/' . $car->img_3) }}" alt="img_3_car" style="width: 485px">
                    ...
                    <input id="car_id" name="car_id" type="hidden" class="form-control validate border" value="{{$car->id}}" />

                    <div class="col-12">
                        <button type="submit" class="btn btn-primary btn-block text-uppercase">Edite Product Now</button>
                    </div>
                </form>
