            ...
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                ...
                <h6 class="text-white text-capitalize ps-3 ml-5">    
                     <button onclick="openUserPopup()" class="btn badge badge-sm bg-gradient-secondary">add</button>
                     </h6>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="{{$user['img']}}" class="avatar avatar-sm me-3 border-radius-lg" alt="user1">
                          </div>
                     ...
                     @else
                      ...
                      <td class="align-middle">
                        <a href="/edit/{{$user['id']}}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Edit
                        </a>
                      </td>
                      <td class="align-middle">
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                ...
                <h6 class="text-white text-capitalize ps-3 ml-5">      
                   <button onclick="openLessorPopup()" class="btn badge badge-sm bg-gradient-secondary">add</button>
                   </h6>
            ...
            <div class="card-body px-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Lessors</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Email</th>
                  ...
                  @foreach($lessors as $lessor)
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div>
                            <img src="{{$lessor['img']}}" class="avatar avatar-sm me-3 border-radius-lg" alt="user1">
                          </div>
                          <div class="d-flex flex-column justify-content-center">
